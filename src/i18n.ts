...
const messages = {
  en: {
    ...
    deleteForever:
      'The meeting "{{ meetingName }}" will be deleted forever. Without the possibility of recovery.',
    yes: "Yes",
    cancel: "Cancel",
    new: "New",
    old: "Old",
    ...
    emailInfo:
      "If the email is found in our database, a message will be sent to it.",
    send: "Send",
    createPassword: "Create your password",
    confirm: "Confirm",
    login: "Login",
    alreadyHaveAccount: "Already have an account?",
    haveNotAccount: "Create account",
    errorOccurred: "An error occurred while sending the email",
    passwordComplexityInfo:
      "The complexity of your password determines the level of protection for your account.",
    lostPasswordWarning:
      "If you lose your password, your transcripts will be lost permanently.",
    password: "Password",
  ...
  ru: {
    ...
    deleteForever:
      'Встреча "{{ meetingName }}" будет удалена навсегда. Без возможности восстановления.',
    yes: "Да",
    cancel: "Отменить",
    new: "Новая",
    old: "Старая",
    ...
    passwordComplexityInfo:
      "Сложность пароля определяет уровень защиты вашей учетной записи.",
    lostPasswordWarning:
      "Если вы потеряете пароль, ваши транскрипты будут утеряны навсегда.",
    password: "Пароль",
